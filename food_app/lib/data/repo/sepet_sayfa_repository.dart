...
import 'package:food_app/data/entity/sepet_yemekler_cevap.dart';

// Sepet yemekleriyle ilgili veritabanı işlemlerini gerçekleştiren sınıf
class SepetYemeklerDaoRepository {
  ...
  // Belirtilen kullanıcı adına ait sepet içindeki yemekleri getirmek için bir HTTP POST isteği gönderir.
  // Gelen cevabı işlemek için parseSepetYemeklerCevap fonksiyonunu kullanarak bir liste döndürür.
  ...
  Future<void> sepeteYemekEkle(String yemek_adi, String yemek_resim_adi, int yemek_fiyat,
